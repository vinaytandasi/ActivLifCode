...
import com.activlife.clinic1.helper.DatabaseHelper;
...
public class MainActivity extends Activity {
	...
	private void addHandlers() {
		...
		backupDatabutton = (Button) findViewById(R.id.BackupDB);		 
	...
	private void launchAddEditPatient(String id) {
		Intent myIntent = new Intent(this, PatientsContainerFragment.class); //new Intent(this, PatientAddEdit.class);
	...
	private void displayListView() {
		 ...
		 db = new DatabaseHelper(getApplicationContext());
		  ...
		  Cursor cursor = PatientTable.getPatients(this);
		  ...
		  dataAdapter.setFilterQueryProvider(new FilterQueryProvider() {
		         public Cursor runQuery(CharSequence constraint) {
		             return PatientTable.fetchPatientsByName(constraint.toString(), MainActivity.this);
		         }
		     });
